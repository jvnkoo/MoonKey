...
/**
 * @brief Timer management for scheduled callbacks
 * @ingroup api
...
public:
     ...
     * @param ms Interval in milliseconds between callback executions
     * @param callback Lua function to call when timer ticks
     * @param targetWindow Optional window title for context-sensitive timers
    ...
    /**
     * @brief Update timers and execute callbacks as needed
     ...
     * * Removes all active timers from the system. Use with caution as this will stop all scheduled callbacks.
     */
    static void Clear();
};